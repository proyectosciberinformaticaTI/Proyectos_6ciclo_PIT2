				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form id="id_form" accept-charset="UTF-8"
							...
							<c:if test="${requestScope.mensajedeFotos != null}">
								<div class="alert alert-success fade in">

									<a href="#" class="close" data-dismiss="alert"
										aria-label="close">×</a> ${requestScope.mensajedeFotos}
								</div>
							</c:if>

							<c:if test="${sessionScope.mensaje6 != null}">
								<div class="alert alert-success fade in">

									<a href="#" class="close" data-dismiss="alert"
										aria-label="close">×</a> ${sessionScope.mensaje6}
								</div>
							</c:if>
							...
							<div class="container" style="margin-top: 50px;">
								...
								<div class="form-group">
									<label class="control-label"> La incidencia se registró
										...
										value="${sessionScope.codigo}" readonly />
									</label>
								</div>
								<div class="form-group">
	...
	<script type="text/javascript">
		...
		$('#id_agrega').click(
				function() {
					...
					console.log(estado);
					if (estado < 0) {
						$('#id_form').attr('action', 'agregarSeleccion');
		...
		$('#id_registra').click(function() {
			if (!tabla.data().any()) {
				...
				$('#id_form').attr('action', 'registraVariasFotos');
				document.getElementById("id_form").submit();

		...
		<div class="row">
				...
				<div class="panel panel-success">
					<div class="panel-heading">
						...
						<a href="" style="text-decoration: none; color: black;">
							xxxxxxxxxxxxxxxxxxxxxxxxxxx <span class="badge pull pull-right">4</span>
						</a>
			...
			<div class="col-md-4">
				<div class="panel panel-info">
					<div class="panel-heading">
						<a href="" style="text-decoration: none; color: black;">
							xxxxxxxxxxxxxxxxxxxxxxxxx <span class="badge pull pull-right">xxxxxxxx</span>
						</a>
			...
			<div class="col-md-4">
				<div class="panel panel-danger">
					<div class="panel-heading">
						<a href="" style="text-decoration: none; color: black;">
							xxxxxx <span class="badge pull pull-right">x</span>
						</a>
					...
					<div class="cardHeader">
						<h1>
							<img width="250px" height="250px;"
								src="http://www.dachtechnik-windschuettl.de/wp-content/uploads/2018/03/man.png" />
						</h1>
					</div>

					<div class="cardContainer">
						<p1>Bienvenido <s:property value="#session.objUsu.usuario" /></p1>
					</div>
				</div>
				<br />
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					<div class="panel-body">
						<center>
							<h1>SISTEMA DE MODERADOR</h1>
							</br> <img width="550px" height="550px" alt="IMAGEN"
								src="https://topali.com.mx/wp-content/uploads/2017/04/policias-seguridad-topali-1.png" />

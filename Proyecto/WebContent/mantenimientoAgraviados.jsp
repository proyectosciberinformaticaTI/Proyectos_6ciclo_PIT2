...
<body class="wide comments example">
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			...
			<h4>
				<i class="glyphicon glyphicon-search"></i>Consulta de Agraviados
			</h4>
		</div>
		<div class="panel-body">
			...
			<div class="modal fade" id="nuevoProducto" tabindex="-1"
				...
				<div class="modal-dialog" role="document">
					...
					<form class="form-horizontal"
						action="consultaltodosporrrAgraviadosppppppppppp"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" onkeypress="solonumeros(event)"
											maxlength="9" class="form-control" id="entidad"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control"
											onkeypress="solonumeros(event)" maxlength="9" id="telefono"
			...
			<form class="form-horizontal" method="POST"
				...
				<div class="form-group row">
					...
					<div class="col-md-5">
						<input type="text" onkeypress="solonumeros(event)"
							...
							placeholder="Inserte el dni del agraviado" onkeyup="load(1);">
					</div>
					<div class="col-md-3">
				...
				<table id="example" data-form="deleteForm"
					...
					<tbody>
						<c:forEach items="${beanagraviados}" var="a">
							<tr>
								<td>${a.idagraviado}</td>
								...
								<td><img alt="Imagen" width="100px" height="100px"
									src="verFotosdeAgraviados?idCodigo=${a.idagraviado}"></td>
